...
singers = ["Paul Simon", "Jeff Beck", "Justin Timberlake", "COIN",
			 "Elton John", "Taylor Swift", "Slayer"]

singers.each do |singer|
  Singer.create name: singer
end

Concerts = [["Paul Simon", "Chicago", "06/06/2018", "8PM", "United Center, Chicago, IL", "https://s1.ticketm.net/tm/en-us/dam/a/f91/9f963f7c-cfc7-485b-a818-136ed7a67f91_626761_CUSTOM.jpg"],
...
concert_data = {
  ...
  "Stars Align Tour: Jeff Beck & Paul Rodgers" => "Jeff Beck",
  "Rock and Pop: Justin Timberlake" => "Justin Timberlake",
  "Ones To Watch Presents COIN: The North American Tour 2018" => "COIN",
  "Elton John: Farewell Yellow Brick Road" => "Elton John",
...
Concerts.each do |entry|
  ...
  concert.singer = Singer.find_by(name: concert_data[concert.name])
...
print "There are now #{Singer.count} singers in the database.\n"
